...
public class output extends javax.swing.JFrame {
     ...
     */
     String idt, idc, idp, tglsewa;
    public output(String idt, String idc, String idp, String tglsewa) {
        initComponents();
        this.idt = idt;
        this.idc = idc;
        this.idp = idp;
        this.tglsewa = tglsewa;
        jLabel1.setText("No Tiket : 2001");
        jLabel2.setText("ID Customer : " + this.idc);
        jLabel3.setText("ID Pacar : 3001");
        jLabel4.setText("Jumlah Yang Harus Dibayar : Rp.350.000");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ID Pacar :");

        jLabel5.setText("Tanggal Sewa :");

        jLabel4.setText("Biaya Sewa :");
